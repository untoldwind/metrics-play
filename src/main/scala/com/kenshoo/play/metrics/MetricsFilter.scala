...
class DisabledMetricsFilter @Inject()(override implicit val mat: Materializer) extends MetricsFilter {
  def apply(nextFilter: (RequestHeader) => Future[Result])(rh: RequestHeader): Future[Result] = {
    nextFilter(rh)
  }
}

class MetricsFilterImpl @Inject() (metrics: Metrics, override implicit val mat: Materializer) extends MetricsFilter {
